# parallel-core-flow implementation handoff

This archive is the source of truth for turning the design into production code. Start from `core-flow-preview.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `core-flow-preview.html`
...
- A single self-contained `core-flow-preview.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `core-flow-preview.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `screenshots/message-editor-390.png`
- `screenshots/messages-details-390.png`
- `screenshots/messages-list-390.png`
- `screenshots/messages-organizer-1440.png`
- `screenshots/messages-participant-1440.png`
- `screenshots/monitoring-organizer-1440.png`
- `screenshots/monitoring-organizer-390.png`
- `screenshots/monitoring-participant-1440.png`
- `screenshots/monitoring-participant-390.png`
- `screenshots/no-access-390.png`
- `screenshots/offline-1440.png`
- `screenshots/offline-390.png`
- `screenshots/plan-b-comparison-1440.png`
- `screenshots/plan-b-comparison-390.png`
- `screenshots/plan-b-confirm-modal-390.png`

## Coding checklist for AI tools
1. Inspect `core-flow-preview.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
