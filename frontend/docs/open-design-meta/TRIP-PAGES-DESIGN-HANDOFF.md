# parallel-trip-pages implementation handoff

This archive is the source of truth for turning the design into production code. Start from `history.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `history.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `history.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `screenshots/history-1440.png`
- `screenshots/history-filters-390.png`
- `screenshots/home-active-1440.png`
- `screenshots/home-active-390.png`
- `screenshots/home-drafts-1440.png`
- `screenshots/home-drafts-390.png`
- `screenshots/home-invitations-1440.png`
- `screenshots/readonly-1440.png`
- `screenshots/readonly-390.png`
- `screenshots/wizard-documents-1440.png`
- `screenshots/wizard-participants-1440.png`
- `screenshots/wizard-review-1440.png`
- `screenshots/wizard-route-1440.png`
- `screenshots/wizard-route-390.png`
- `screenshots/wizard-type-1440.png`
- `screenshots/wizard-type-390.png`
- `TRIP-PAGES-INTEGRATION.md`

## Coding checklist for AI tools
1. Inspect `history.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
